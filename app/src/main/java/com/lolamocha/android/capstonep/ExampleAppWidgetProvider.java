...
import static com.lolamocha.android.capstonep.ExampleAppWidgetConfig.KEY_BUTTON_TEXT;
import static com.lolamocha.android.capstonep.ExampleAppWidgetConfig.SHARED_PREFS;
...
public class ExampleAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        for (int appWidgetId : appWidgetIds) {
            Intent buttonIntent = new Intent(context, MoviesActivity.class);
